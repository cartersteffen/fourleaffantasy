...
//  fourleaffantasy
//
//  Created by Carter Steffen on 9/6/24.
//

import Foundation

let nflLogosFreebie: [String: String] = [
...
func getLastWord(of team: String) -> String {
    let words = team.split(separator: " ")
    return words.last.map { String($0) } ?? ""
}
